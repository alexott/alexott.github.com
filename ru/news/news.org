...
Статья про [[../writings/emacs-vcs/EmacsGit.html][Emacs & Git]] была сильно обновлена -- добавлены описания пакетов git-emacs,
magit и некоторых вспомогательных пакетов

* DONE Рассказ про пакет aHg                           :emacs:article:mercurial:
  CLOSED: [2008-10-13 Mon 16:38]

В рассказ про работу с Mercurial добавил [[../writings/emacs-vcs/EmacsMercurial.html#sec5][раздел про пакет aHg]]

* DONE Окончательная версия статьи про Emacs и Erlang     :emacs:erlang:article:
  CLOSED: [2008-08-25 Mon 13:09]

Закончил статью про [[../writings/emacs-devenv/EmacsErlang.html][использование Emacs для разработки на языке Erlang]] Замечания и
